package com.example.nearmeapplication.activities
...
import com.example.nearmeapplication.adapter.DirectionStepAdapter
import com.example.nearmeapplication.databinding.ActivityDirectionBinding
import com.example.nearmeapplication.databinding.BottomSheetLayoutBinding
import com.example.nearmeapplication.models.directionPlaceModel.DirectionLegModel
    ...
    private fun getDirection(mode: String) {
        ...
        if (isLocationPermissionOk) {
            val url = "https://maps.googleapis.com/maps/api/directions/json?" +
                    ...
                    "&mode=" + mode +
                    "&key=" + "AIzaSyCTHsiN5S3iNZulNWCfo3kKLtZhrpk1AMM"
